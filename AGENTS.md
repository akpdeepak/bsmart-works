...
- **Flyway high-water mark:** **V80** (`V80__unify_custom_fields_to_field_def.sql`; note: V16 was
  ...
  work_items.custom_fields JSONB left in place for a later contract migration to drop).
