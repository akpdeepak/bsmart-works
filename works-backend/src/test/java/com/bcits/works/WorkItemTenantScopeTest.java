...
class WorkItemTenantScopeTest {
    ...
    void getAllWorkItems_confinesResultsToCallersWorkspaces() {
        ...
        when(jdbc.query(anyString(), any(RowMapper.class), any(Object.class), any(Object.class), any(Object.class), any(Object.class)))
                .thenReturn(List.of());

        controller.getAllWorkItems("WS-1", null, null, 0, 50);

        ArgumentCaptor<String> sql = ArgumentCaptor.forClass(String.class);
        verify(jdbc).query(sql.capture(), any(RowMapper.class), any(Object.class), any(Object.class), any(Object.class), any(Object.class));
