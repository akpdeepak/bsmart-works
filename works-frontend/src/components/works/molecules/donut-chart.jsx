        ...
        {items.map((d, i) => (
          <li key={d.label} className="flex items-center gap-2 text-xs">
            <span aria-hidden="true"
              className={cn('inline-block h-2.5 w-2.5 flex-shrink-0 rounded-full bg-current',
            ...
            <span className="w-9 flex-shrink-0 text-right text-neutral-600 dark:text-neutral-400">
