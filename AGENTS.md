...
- **Flyway high-water mark:** **V77** (`V77__type_field_prefs.sql`; note: V16 was
  ...
  backfill parent_id into work_item_links as PARENT links — hierarchy surfaced in the Links section;
  V77 = type_field_prefs — per-type field visibility on the detail surface).
