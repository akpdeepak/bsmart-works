 ...
 * (see the seed in {@code V52}) — never change it without a forward migration that re-chains.
 *
...
public final class AuditHashChain {
    ...
    /** The exact string that gets hashed for one entry. Mirrors the SQL seed in V52. */
