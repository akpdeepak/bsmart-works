...
- **Active iteration:** **11 (in progress)** — broad AI expansion; built on the **AI Control Plane**
  ...
  **Iteration 15 (Scrum Master Cockpit Cap V + Product Owner Workspace Cap W) delivered** on the
  AI-Control-Plane foundation, by explicit owner directive (built ahead of 12–14).
- **Flyway high-water mark:** **V41** (`V41__iteration15_scrum_po.sql`; note: V16 was skipped, V23 does not exist).
- **Next migration:** **`V42__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
