...
describe('buildBulkPreview', () => {
  it('previews a priority change and counts only rows that differ', () => {
  ...
  it('previews addLabel without changing items that already have the tag', () => {
  ...
  it('previews removeLabel only for items carrying the tag', () => {
