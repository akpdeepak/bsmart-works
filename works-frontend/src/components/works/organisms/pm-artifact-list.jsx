...
/**
 * PmArtifactList — generic table-plus-empty-state used by every PM tab
 * (risks, assumptions, issues, dependencies, decisions, actions, stakeholders,
 * lessons learned). Extracted from App.jsx (TD-003).
 */
