...
> **19 (complete)**, Flyway high-water **V50**, next **V51**.
...
`SecurityAdminController`, `AuditLogController`, `CompliancePrivacyController`. Migration
`V50__iteration19_enterprise_security.sql`.
