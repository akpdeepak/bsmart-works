...
export function RouteOutlet({ model }) {
  ...
  return (
          ...
          {view === 'leadership' && <LeadershipConsoleView workspaceId={activeWorkspaceId} onToast={showToast} />}
          {view === 'adminops' && <AdminOpsView workspaceId={activeWorkspaceId} onToast={showToast} />}
          {view === 'operatingmodel' && <OperatingModelView workspaceId={activeWorkspaceId} api={api} onToast={showToast} />}
