<!-- GENERATED FROM ai-rules/ — do not edit by hand.
     ...
     Provider projection: Codex documentation scope. -->

# Documentation and product rules

Canonical detail: `ai-rules/rulebooks/20-PRODUCT.md`. These rules apply only when this domain is in scope.
