...
- **Flyway high-water mark:** **V67** (`V67__oauth_credentials_and_key_rotation.sql`; note: V16 was
  ...
  (boot unblock); V67 = OAuth credentials + AES-256 encryption + PII vault).
- **Next migration:** **`V68__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
