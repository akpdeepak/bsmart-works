    ...
    <div>
      {!activeStandup ? (
        ...
        <div className="w-full">
          <Button variant="link" size="sm" onClick={() => setActiveStandup(null)} className="mb-3"><ArrowLeft className="inline-block h-3.5 w-3.5 mr-1 align-text-bottom" aria-hidden="true" />All standups</Button>
