...
function ProjectCard({ p, workItems, projectMetrics, projectMetricsLoading, isDone, userName, handleArchiveProject }) {
  const { t } = useI18n();
  ...
  return (
    <Card padding="none" variant="outlined" className="rounded-xl p-5 hover:shadow-sm transition-shadow">
