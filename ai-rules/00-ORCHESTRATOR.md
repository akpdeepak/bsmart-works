...
- **Flyway high-water mark:** **V77** (`V77__ceremony_sessions_attendance.sql`; note: V16 was
  ...
  project_team_members — per-project team roles (V70 role_key vocabulary) for the role-adaptive
  Sprint Cockpit; V77 = ceremony_sessions + ceremony_attendees — first-class sprint ceremonies
  with per-member attendance).
- **Next migration:** **`V78__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
