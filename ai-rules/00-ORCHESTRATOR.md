...
- **Flyway high-water mark:** **V71** (`V71__product_id_and_type_seed.sql`; note: V16 was
...
- **Next migration:** **`V72__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
