...
export function CardSkeleton({ className }) {
  return (
    <div aria-busy="true" aria-label="Loading card" className={cn('glass-card p-4 space-y-3', className)}>
...
export function ChartSkeleton({ className }) {
  return (
    <div aria-busy="true" aria-label="Loading chart" className={cn('glass-card p-4 space-y-3', className)}>
