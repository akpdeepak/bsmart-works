...
|---|---|---|---:|---:|
| 1 | 1.0 | Foundation — The Works MVP | 12 | 4 |
...
| I01-S05 | B | Projects | In-Progress | claude/spec-refactor-i01-s05-projects | — | — | ProjectService (RBAC→service), tenant-isolated reads (no findAll leak), workspace-scoped events. |
