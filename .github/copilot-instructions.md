...
- **Flyway high-water mark:** **V117**. (V117 = revoked_tokens — a per-token (jti) blocklist for logout
...
- **Next migration:** **`V118__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
