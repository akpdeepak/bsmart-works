...
- **Flyway high-water mark:** **V81** (`V81__impediment_raise_types.sql`; note: V16 was
...
- **Next migration:** **`V82__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
