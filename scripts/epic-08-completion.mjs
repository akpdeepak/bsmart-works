...
const repository = read('works-backend/src/main/java/com/bcits/works/messaging/api/NotificationRepository.java');
const notification = read('works-backend/src/main/java/com/bcits/works/messaging/api/Notification.java');
const batch = read('works-backend/src/main/java/com/bcits/works/messaging/api/NotificationBatchService.java');
