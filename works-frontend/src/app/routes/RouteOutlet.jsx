  ...
  return (
          ...
          {view === 'developer' && (
            <DeveloperWorkspace
              workspaceId={activeWorkspaceId}
              onToast={showToast}
              onOpenItem={(id) => api.send(`/work-items/${id}`)
          ...
          {view === 'backlog' && (
            <BacklogView
              loading={loading}
              workItems={workItems}
              backlogItems={backlogItems} totalBacklogCount={totalBacklogCount} fetchBacklog={fetchBacklog}
              sprints={sprints}
              users={users}
