...
- **Flyway high-water mark:** **V119**. (V119 = webauthn_fido2_cose_columns — real WebAuthn/FIDO2
...
- **Next migration:** **`V120__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
