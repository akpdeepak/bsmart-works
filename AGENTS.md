...
## 8. Architecture: Working Principle, Attributes & Modular Design

### 8.1 Working Principle — Modular Monolith, Microservice-Ready
...
### 8.2 Architectural Attributes (Quality Attributes)

| Attribute | How It Is Achieved |
|-----------|-------------------|
| **Maintainability** | One way per operation (§2.3 Engineering Principles). Tooling enforces it. No drive-by refactors. |
...
## 9. UI/UX Design System — Look, Feel & Interaction
...
## 10. How AI Tools Auto-Follow These Rules (Never Repeat Yourself)
