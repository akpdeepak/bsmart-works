...
| EPIC 6 - Simplified Information Architecture and Navigation | Code-verified complete | `codex/epic-06-navigation-completion` | #400 + closeout PR pending | 11/11 EPIC gate; 1,782 frontend tests; route/server/locale parity; axe; backend RBAC contract | `docs/implementation/epics/EPIC-06-simplified-navigation-completion.md` | Visible permission-aware More, 38 deep links, role landing, localized palette/breadcrumbs, one nav catalogue |
...
PR pending; merge only after GitHub CI, then resume with EPIC 7.
