...
- **Flyway high-water mark:** **V113**. (V110–V113 are the Phase-1 PII-vault / crypto-shredding
  ...
  declared PII custom fields route their text values to the vault). V91–V109 add the Know Studio knowledge-base + transformation
...
- **Next migration:** **`V114__<description>.sql`**. *(Supersedes every stale lower-numbered reference.)*
